...
{
    public class TADivide : Primitives, Operations
    {
        ...
        public TADivide(TAInt a, TAInt b, string staticName) : base(staticName)
        {
            SetObjects(a, b);
        }
        public TADivide(TADouble a, TADouble b, string staticName) : base(staticName)
        {
            SetObjects(a, b);
        }
        public TADivide(TAInt a, TAInt b)
        {
            SetObjects(a, b);
        }
        public TADivide(TADouble a, TADouble b)
        {
            SetObjects(a, b);
        }

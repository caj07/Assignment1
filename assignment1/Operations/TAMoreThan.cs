...
{
    public class TAMoreThan : TABool,Operations
    {
        ...
        public TAMoreThan(TAInt a, TAInt b, string staticName) : base(staticName)
        {
            SetObjects(a, b);
        }
        public TAMoreThan(TADouble a, TADouble b, string staticName) : base(staticName)
        {
            SetObjects(a, b);
        }
        public TAMoreThan(TAInt a, TAInt b)
        {
            SetObjects(a, b);
        }
        public TAMoreThan(TADouble a, TADouble b)
        {
            SetObjects(a, b);
        }

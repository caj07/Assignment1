...
{
    public class TALessThan :TABool, Operations
    {
        ...
        public TALessThan(TAInt a, TAInt b, string staticName) : base(staticName)
        {
            SetObjects(a, b);
        }
        public TALessThan(TADouble a, TADouble b, string staticName) : base(staticName)
        {
            SetObjects(a, b);
        }
        public TALessThan(TAInt a, TAInt b)
        {
            SetObjects(a, b);
        }
        public TALessThan(TADouble a, TADouble b)
        {
            SetObjects(a, b);
        }
